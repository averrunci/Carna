...
namespace Carna.Runner
{
    internal class FixtureStepRunningResultAssertion : AssertionObject
    {
        ...
        public static FixtureStepRunningResultAssertion Of(FixtureStepResult stepResult) => new(stepResult.Step, stepResult.StartTime.HasValue, stepResult.EndTime.HasValue, stepResult.Duration.HasValue, stepResult.Exception, stepResult.Status);
    }
}
