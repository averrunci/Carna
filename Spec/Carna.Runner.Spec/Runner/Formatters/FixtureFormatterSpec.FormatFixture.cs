...
class FixtureFormatterSpec_FormatFixture : FixtureSteppable
{
    ...
    FormattedDescription FormattedDescription { get; set; } = default!;
...
Description line 3");
    ...
    void Ex11()
    {
        ...
        var benefitDescription = FormattedDescription.Items.ElementAt(0);
        Then("the first line indent of the first item should be empty", () => benefitDescription.FirstLineIndent == string.Empty);
        Then("the line count of the first item should be 1", () => benefitDescription.Lines.Count() == 1);
        Then("the first element of the first item line should be 'In order {the Benefit of the given FeatureAttribute}'", () => benefitDescription.Lines.ElementAt(0) == $"In order {featureAttribute.Benefit}");
        Then("the line indent of the first item should be empty", () => benefitDescription.LineIndent == string.Empty);
        Then("the items of the first item should be empty", () => !benefitDescription.Items.Any());

        var roleDescription = FormattedDescription.Items.ElementAt(1);
        Then("the first line indent of the second item should be empty", () => roleDescription.FirstLineIndent == string.Empty);
        Then("the line count of the second item should be 1", () => roleDescription.Lines.Count() == 1);
        Then("the first element of the second item line should be 'As {the Role of the given FeatureAttribute}'", () => roleDescription.Lines.ElementAt(0) == $"As {featureAttribute.Role}");
        Then("the line indent of the second item should be empty", () => roleDescription.LineIndent == string.Empty);
        Then("the items of the second item should be empty", () => !roleDescription.Items.Any());

        var featureDescription = FormattedDescription.Items.ElementAt(2);
        Then("the first line indent of the third item should be empty", () => featureDescription.FirstLineIndent == string.Empty);
        Then("the line count of the third item should be 1", () => featureDescription.Lines.Count() == 1);
        Then("the first element of the third item line should be 'I want {the Feature of the given FeatureAttribute}'", () => featureDescription.Lines.ElementAt(0) == $"I want {featureAttribute.Feature}");
        Then("the line indent of the third item should be empty", () => featureDescription.LineIndent == string.Empty);
        Then("the items of the third item should be empty", () => !featureDescription.Items.Any());
    }
    ...
    void Ex12()
    {
        ...
        Then("the first element of the item line should be 'Background {background of the fixture}'", () => backgroundDescription.Lines.ElementAt(0) == $"Background: {background}");
        Then("the line indent of the item should be '            '(12 spaces)", () => backgroundDescription.LineIndent == "            ");
...
Third Fixture Background";
        ...
        Then("the first element of the item line should be the first line of the given background", () => backgroundDescription.Lines.ElementAt(0) == "Background: First Fixture Background");
    ...
    void Ex14()
    {
        ...
        Then("the first element of the forth item line should be 'Background {background of the fixture}'", () => backgroundDescription.Lines.ElementAt(0) == $"Background: {background}");
        Then("the line indent of the forth item should be '            '(12 spaces)", () => backgroundDescription.LineIndent == "            ");
