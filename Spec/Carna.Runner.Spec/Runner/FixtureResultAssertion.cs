...
namespace Carna.Runner
{
    internal class FixtureResultAssertion : AssertionObject
    {
        ...
        public static FixtureResultAssertion Of(FixtureResult result) => new FixtureResultAssertion(result.StartTime.HasValue, result.EndTime.HasValue, result.Duration.HasValue, new ActualValueProperty<Exception>(result.Exception), result.StepResults.Count(), result.Results.Count(), result.Status);
    }
}
