...
namespace Carna.Runner
{
    abstract class FixtureSpec_FixtureImplementedIFixtureSteppableContext : FixtureSteppable, IDisposable
    {
        ...
        public FixtureSpec_FixtureImplementedIFixtureSteppableContext()
        {
        ...
        protected void Ex01()
        {
            ...
            Expect("the duration of the reuslt on FixtureStepRunning event should not have value", () => !FixtureStepRunningResult.Duration.HasValue);
