...
namespace Carna.Runner.Step
{
    ...
    class ThenStepRunnerSpec_Constrains : FixtureSteppable
    {
        ...
        [Example("When latest WhenStep that has already run has an exception and ThenStep has an assertion without Exception that returns boolean, ThenStep is not run")]
        void Ex03()
        {
        ...
        [Example("When latest WhenStep that has already run has an exception and ThenStep has an assertion without Exception that is Action, ThenStep is not run")]
        void Ex04()
        {
        ...
        [Example("When latest WhenStep that has already run does not have an exception but other WhenStep that has already run has an exception and ThenStep has an assertion without Exception that returns boolean, ExpectStep is run")]
        void Ex05()
        {
            Given("ThenStep that has an assertion without Exception that returns true", () => Step = FixtureSteps.CreateThenStep(() => true));
            Given("a result of GivenStep that does not have an exception", () => StepResults.Add(FixtureStepResult.Of(FixtureSteps.CreateGivenStep()).Passed().Build()));
        ...
        [Example("When latest WhenStep that has already run does not have an exception but other WhenStep that has already run has an exception and ThenStep has an assertion without Exception that does not throw any exceptions, ExpectStep is run")]
        void Ex06()
        {
            Given("ThenStep that has an assertion without Exception that does not throw any exceptions", () => Step = FixtureSteps.CreateThenStep(() => { }));
            Given("a result of GivenStep that does not have an exception", () => StepResults.Add(FixtureStepResult.Of(FixtureSteps.CreateGivenStep()).Passed().Build()));
