...
namespace Carna.Runner.Step
{
    ...
    class ThenStepRunnerSpec_StepRunningWithoutExceptionAsync : FixtureSteppable
    {
        ...
        void Ex01()
        {
            ...
            Given("async ThenStep that has an assertion that does not throw any exceptions", () => Step = FixtureSteps.CreateThenStep(async () =>
            {
        ...
        void Ex02()
        {
            Given("async ThenStep that has an assertion that throws an exception", () => Step = FixtureSteps.CreateThenStep(async () =>
            {
                await Task.Delay(100);
                throw new Exception();
            }));
