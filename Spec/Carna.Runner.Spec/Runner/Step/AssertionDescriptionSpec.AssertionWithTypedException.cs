...
namespace Carna.Runner.Step
{
    ...
    class AssertionDescriptionSpec_AssertionWithTypedException : FixtureSteppable
    {
        ...
        void Ex03()
        {
            ...
            Expect(
                "the description should be 'expected: 3 but was: 14'",
                () => AssertionDescription.Of(Assertion, Exception).ToString() == "expected: 3 but was: 14"
            );
        }
        ...
        void Ex04()
        {
            ...
            Expect(
                "the description should be 'expected: not 14 but was: 14'",
                () => AssertionDescription.Of(Assertion, Exception).ToString() == "expected: not 14 but was: 14"
            );
        }
        ...
        void Ex05()
        {
            ...
            Expect(
                "the description should be 'expected: less than 10 but was: 14'",
                () => AssertionDescription.Of(Assertion, Exception).ToString() == "expected: less than 10 but was: 14"
            );
        }
        ...
        void Ex06()
        {
            Given("an assertion that has 'exc.ParamName.Length <= 10' where exc.ParamName='Parameter name'", () => Assertion = CreateAssertion(exc => exc.ParamName.Length <= 10));
            Expect(
                "the description should be 'expected: less than or equal 10 but was: 14'",
                () => AssertionDescription.Of(Assertion, Exception).ToString() == "expected: less than or equal 10 but was: 14"
            );
        }
        ...
        void Ex07()
        {
            ...
            Expect(
                "the description should be 'expected: greater than 15 but was: 14'",
                () => AssertionDescription.Of(Assertion, Exception).ToString() == "expected: greater than 15 but was: 14"
            );
        }
        ...
        void Ex08()
        {
            Given("an assertion that has 'exc.ParamName.Length >= 15' where exc.ParamName='Parameter name'", () => Assertion = CreateAssertion(exc => exc.ParamName.Length >= 15));
            Expect(
                "the description should be 'expected: greater than or equal 15 but was: 14'",
                () => AssertionDescription.Of(Assertion, Exception).ToString() == "expected: greater than or equal 15 but was: 14"
            );
        }
        ...
        void Ex12()
        {
            ...
            Expect(
                "the description should be 'expected: Param but was: null'",
                () => AssertionDescription.Of(Assertion, new ArgumentNullException(null)).ToString() == "expected: Param but was: null"
            );
        }
...
",
  ...
  [failed] expected: 3 but was: 14"
        ...
        void Ex14()
        {
            ...
            Expect(
                @"the description should be as follows:
  [failed] expected: Parameter but was: Parameter name
  [failed] expected: 3 but was 14
  [passed]
",
                () => AssertionDescription.Of(Assertion, Exception).ToString() == @"
