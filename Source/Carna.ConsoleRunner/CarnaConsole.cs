...
namespace Carna.ConsoleRunner
{
    internal static class CarnaConsole
    {
        ...
        public static void WriteLine(string format, params object[] args) => Console.WriteLine(format ?? string.Empty, args);

        public static void Write(object value) => Console.Write(value);
        public static void Write(string format, params object[] args) => Console.Write(format ?? string.Empty, args);
        ...
        public static void WriteLineReady(string format, params object[] args) => WriteLine(ConsoleColor.Gray, format, args);

        public static void WriteReady(object value) => Write(ConsoleColor.Gray, value);
        public static void WriteReady(string format, params object[] args) => Write(ConsoleColor.Gray, format, args);
        ...
        private static void WriteLine(ConsoleColor foregroundColor, string format, params object[] args) => Write(() => Console.WriteLine(format ?? string.Empty, args), foregroundColor);

        private static void Write(ConsoleColor foregroundColor, object value) => Write(() => Console.Write(value), foregroundColor);
        private static void Write(ConsoleColor foregroundColor, string format, params object[] args) => Write(() => Console.Write(format ?? string.Empty, args), foregroundColor);
