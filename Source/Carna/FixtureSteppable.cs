...
public class FixtureSteppable : IFixtureSteppable
{
    ...
    {
        ((IFixtureSteppable)this).Stepper?.Take(new ExpectStep(description, GetType(), callerMemberName, callerFilePath, callerLineNumber));
    }
    ...
    {
        ((IFixtureSteppable)this).Stepper?.Take(new ExpectStep(description, assertion, GetType(), callerMemberName, callerFilePath, callerLineNumber));
    }
    ...
    {
        ((IFixtureSteppable)this).Stepper?.Take(new ExpectStep(description, asyncAssertion, GetType(), callerMemberName, callerFilePath, callerLineNumber));
    }
    ...
    {
        ((IFixtureSteppable)this).Stepper?.Take(new GivenStep(description, GetType(), callerMemberName, callerFilePath, callerLineNumber));
    }
    ...
    {
        ((IFixtureSteppable)this).Stepper?.Take(new GivenStep(description, arrangement, GetType(), callerMemberName, callerFilePath, callerLineNumber));
    }
    ...
    {
        ((IFixtureSteppable)this).Stepper?.Take(new GivenStep(description, asyncArrangement, GetType(), callerMemberName, callerFilePath, callerLineNumber));
    }
    ...
    {
        ((IFixtureSteppable)this).Stepper?.Take(new WhenStep(description, GetType(), callerMemberName, callerFilePath, callerLineNumber));
    }
    ...
    {
        ((IFixtureSteppable)this).Stepper?.Take(new WhenStep(description, action, GetType(), callerMemberName, callerFilePath, callerLineNumber));
    }
    ...
    {
        ((IFixtureSteppable)this).Stepper?.Take(new WhenStep(description, millisecondsTimeout, action, GetType(), callerMemberName, callerFilePath, callerLineNumber));
    }
    ...
    {
        ((IFixtureSteppable)this).Stepper?.Take(new WhenStep(description, timeout, action, GetType(), callerMemberName, callerFilePath, callerLineNumber));
    }
    ...
    {
        ((IFixtureSteppable)this).Stepper?.Take(new WhenStep(description, asyncAction, GetType(), callerMemberName, callerFilePath, callerLineNumber));
    }
    ...
    {
        ((IFixtureSteppable)this).Stepper?.Take(new WhenStep(description, millisecondsTimeout, asyncAction, GetType(), callerMemberName, callerFilePath, callerLineNumber));
    }
    ...
    {
        ((IFixtureSteppable)this).Stepper?.Take(new WhenStep(description, timeout, asyncAction, GetType(), callerMemberName, callerFilePath, callerLineNumber));
    }
    ...
    {
        ((IFixtureSteppable)this).Stepper?.Take(new ThenStep(description, GetType(), callerMemberName, callerFilePath, callerLineNumber));
    }
    ...
    {
        ((IFixtureSteppable)this).Stepper?.Take(new ThenStep(description, assertion, GetType(), callerMemberName, callerFilePath, callerLineNumber));
    }
    ...
    {
        ((IFixtureSteppable)this).Stepper?.Take(new ThenStep(description, exceptionAssertion, GetType(), callerMemberName, callerFilePath, callerLineNumber));
    }
    ...
    {
        ((IFixtureSteppable)this).Stepper?.Take(new ThenStep(description, asyncAssertion, GetType(), callerMemberName, callerFilePath, callerLineNumber));
    }
    ...
    {
        ((IFixtureSteppable)this).Stepper?.Take(new ThenStep(description, asyncExceptionAssertion, GetType(), callerMemberName, callerFilePath, callerLineNumber));
    }
    ...
    {
        ((IFixtureSteppable)this).Stepper?.Take(new ThenStep(description, typeof(T), GetType(), callerMemberName, callerFilePath, callerLineNumber));
    }
    ...
    protected virtual void Then<T>(string description, Expression<Func<T, bool>> exceptionAssertion, [CallerMemberName] string callerMemberName = "", [CallerFilePath] string callerFilePath = "", [CallerLineNumber] int callerLineNumber = 0) where T : Exception
    {
        ...
        ((IFixtureSteppable)this).Stepper?.Take(new ThenStep(description, typeof(T), Expression.Lambda<Func<Exception, bool>>(Expression.Invoke(exceptionAssertion, Expression.Invoke(convert, parameter)), parameter), GetType(), callerMemberName, callerFilePath, callerLineNumber));
    }
    ...
    {
        ((IFixtureSteppable)this).Stepper?.Take(new ThenStep(description, typeof(T), exc => exceptionAssertion((T)exc), GetType(), callerMemberName, callerFilePath, callerLineNumber));
    }
    ...
    {
        ((IFixtureSteppable)this).Stepper?.Take(new ThenStep(description, typeof(T), exc => asyncExceptionAssertion((T)exc), GetType(), callerMemberName, callerFilePath, callerLineNumber));
    }
    ...
    {
        ((IFixtureSteppable)this).Stepper?.Take(new NoteStep(description, GetType(), callerMemberName, callerFilePath, callerLineNumber));
    }
