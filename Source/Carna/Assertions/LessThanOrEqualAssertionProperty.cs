...
{
    /// <summary>
    /// Represents a property to assert that is less than or equal.
    /// </summary>
    /// <typeparam name="TValue">The type of the property value to assert.</typeparam>
    public class LessThanOrEqualAssertionProperty<TValue> : AssertionProperty<TValue> where TValue : IComparable<TValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LessThanOrEqualAssertionProperty{TValue}"/> class
        /// with the specified property value to assert.
        /// </summary>
        /// <param name="value">The value of the property to assert.</param>
        public LessThanOrEqualAssertionProperty(TValue value) : base(value)
        {
        }
        ...
        protected override string Format(string value) => $"less than or equal {value}";
    }
}
