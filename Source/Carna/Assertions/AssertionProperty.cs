...
namespace Carna.Assertions
{
    ...
    public abstract class AssertionProperty<TValue> : IAssertionProperty
    {
        ...
        public override string ToString() => Format(ReferenceEquals(Value, null) ? "<null>" : Value.ToString());
        ...
        protected virtual string Format(string value) => value;
        ...
        protected virtual bool Assert(IAssertionProperty other)
        {
            ...
            if (!(other is AssertionProperty<TValue> assertionProperty)) return false;
